...
?>
	<div class="main-header" style="color:#B37463;">
		<div class="container">
			<div class="row">
...
<div class="logo">
	<a href="index.php">
		...
		<h2 style="color:#B37463;">Shopping Portal</h2>

	</a>
</div>		
</div>
<div class="col-xs-12 col-sm-12 col-md-6 top-search-holder"style="color:#B37463;">
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->				</div><!-- /.top-search-holder -->
				...
				<div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row" style="color:#B37463;">
					<!-- ============================================================= SHOPPING CART DROPDOWN ============================================================= -->
<?php
if(!empty($_SESSION['cart'])){
	?>
	<div class="dropdown dropdown-cart" style="color:#B37463;">
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				<div class="total-price-basket">
					<span class="lbl">cart -</span>
					<span class="total-price">
						<span class="sign" style="color:#B37463;">Rs.</span>
						<span class="value" style="color:#B37463;" ><?php echo $_SESSION['tp']; ?></span>
					</span>
				</div>
				<div class="basket">
					<i class="glyphicon glyphicon-shopping-cart"></i>
				</div>
				<div class="basket-item-count" style="color:#B37463;"><span class="count"><?php echo $_SESSION['qnty'];?></span></div>
